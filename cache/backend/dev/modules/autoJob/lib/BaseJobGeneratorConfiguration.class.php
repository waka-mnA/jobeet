...
abstract class BaseJobGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return 'Editing Job "%%company%% is looking fo a %%position%%"';
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'is_activated' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Boolean',  'label' => 'Activated?',  'help' => 'Whether the use has activated the job',  'or' => 'not',),
