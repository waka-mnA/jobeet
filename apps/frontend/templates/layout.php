...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    <!--default title can be defined in the second argument of include_slot()-->
    <title>
      <?php include_slot('title', 'Jobeet - Your best job board') ?>
    </title>

    <!-- could be following using the
    <title>
  ...
  href="<?php echo url_for('job', array('sf_format' => 'atom'), true) ?>" />
    ...
    <?php use_javascript('jquery-3.0.0.min.js')?>
